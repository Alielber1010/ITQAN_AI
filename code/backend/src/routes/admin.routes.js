...
const { ruleSchema, userRoleSchema } = require('../validators');
 ...
 */
router.post('/users/role', validate(userRoleSchema), async (req, res) => {
 ...
 */
router.post('/rules', validate(ruleSchema), async (req, res) => {
